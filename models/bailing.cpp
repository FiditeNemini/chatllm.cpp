...
namespace chatllm::bailing::moe2
{
    ...
    class SelfAttention : public QKNormedRoPEAttention<RMSNormInplace, BaseAttention>
    {
    public:
            ...
            ggml::tensor *attn_scores) override
        {
            if (nullptr == mask)
            {
                return QKNormedRoPEAttention<RMSNormInplace, BaseAttention>::attn_scores_to_probs(ctx, hidden_size, n_past, qlen, attn_scores);
            }
