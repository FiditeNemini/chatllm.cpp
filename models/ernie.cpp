...
namespace chatllm::qianfan::ocr
{
    ...
    public:
        ...
        ConditionalGeneration(const Config &config, const RuntimeConfig &runtime_config,
            ModelType type = (ModelType)MODEL_TYPE_QIANFAN_OCR);
...
namespace chatllm
{
    ...
    REGISTER_MODEL_LOADER(QIANFAN_OCR,           qianfan::ocr, 1);
}