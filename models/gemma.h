...
namespace chatllm::gemma::v3
{
    ...
    template <int sliding_window_len> class Gemma3SWASelfAttention : public QKNormedRoPEAttention<RMSNormInplace, SlidingWindowAttentionImpl<sliding_window_len>>
    {
    public:
        Gemma3SWASelfAttention(InitContext *ctx, int hidden_size, int num_attention_heads, int num_kv_heads, int head_dim, int max_length)
            : QKNormedRoPEAttention<RMSNormInplace, SlidingWindowAttentionImpl<sliding_window_len>>
    ...
    class Gemma3FullSelfAttention : public QKNormedRoPEAttention<RMSNormInplace, BaseAttention>
    {
    public:
